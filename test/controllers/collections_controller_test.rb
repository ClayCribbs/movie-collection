...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { movie_id: @collection.movie_id, name: @collection.name, user_id: @collection.user_id } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { movie_id: @collection.movie_id, name: @collection.name, user_id: @collection.user_id } }
